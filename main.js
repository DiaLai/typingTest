...
const handleShowScore = () => {
    const { correct, wrong } = gameStats;

    showScore[0].innerHTML = correct + ' correct words!';
    showScore[1].innerHTML = wrong + (wrong == 1 ? ' misspelled word. ' : ' misspelled words. ');
...
const onGameOver = element => {
    ...
    if(gameStats.wrong === 0 && gameStats.correct)
        element.innerHTML = 'GREAT GOING';
    else
        element.innerHTML = 'PRACTICE IS THE KEY';
